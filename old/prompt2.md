...
I want to create a secound reference guide for: controlling the robomaster S1. The S1 is already rooted and in SDK mode as it is described on the folder below.
...
local folder '/home/komodor/robomastr/RoboMaster-SDK'
