...
Required Sections:
    ...
    API Contracts (if applicable - full-stack projects)
...
For Existing Projects:
    ...
    Extract and document the existing conventions following the structure above
    Be specific and use actual examples from the codebase
...
For New Projects:
    ...
    After I answer, research best practices:
    ...
    Create global rules based on research and best practices
...
Critical Requirements:
    ...
    Use examples liberally - Show, don't just tell. Furthermor ignore the "old" folder in your analysis.
